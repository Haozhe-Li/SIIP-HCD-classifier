...
from core.data_table import Output_Label, LLM_HCD_Label, List_Student_HCD_Label, List_Output_Label
...
class FinalProcessing:
    ...
    def final_eval(self, student_hcd_label: List_Student_HCD_Label, llm_hcd_label: list[LLM_HCD_Label]) -> List_Output_Label:
        ...
        for student_entry, llm_entry in zip(student_hcd_label.tables, llm_hcd_label):
            response.append(self.bound_model.invoke(
                    [
